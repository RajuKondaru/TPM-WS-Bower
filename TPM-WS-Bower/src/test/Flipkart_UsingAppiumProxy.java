...
public class Flipkart_UsingAppiumProxy {
	...
	public static void main(String[] args) throws MalformedURLException {
		...
		try {
		  ...
		  //driver.findElement(By.id("com.flipkart.android:id/search_autoCompleteTextView")).sendKeys("iphone7");
		        ...
		        driver.findElement(By.id("com.flipkart.android:id/product_addtocart_1")).click();
		        ...
		        driver.findElement(By.xpath("//android.widget.TextView[@text='My Account']My Account")).click();
		        String str="Logout of this app";
		       
		        driver.findElement(By.xpath("//android.view.View[@content-desc='Logout of this app']")).click();
