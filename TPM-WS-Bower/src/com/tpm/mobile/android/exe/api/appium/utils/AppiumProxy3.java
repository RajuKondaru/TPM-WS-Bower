 ...
 *
 */
public class AppiumProxy3 {
	private static final Logger log = Logger.getLogger(AppiumProxy3.class);
...
/*	private  String  deviceUdid = null;
	...
	private void initialize() {
		...
		try {
			prop.load(AppiumProxy3.class.getClassLoader().getResourceAsStream("config.properties"));
